...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'walle' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/Project-WALLE/catkin_ws/install/lib;/home/ubuntu/Project-WALLE/catkin_ws/devel/lib;/home/ubuntu/ROS_Test/catkin_ws/devel/lib;/opt/ros/noetic/lib)
